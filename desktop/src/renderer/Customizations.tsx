...
export function Customizations({ customizations, nativeAliases, issues, onChange }: Props) {
  ...
  return <article className="panel customization-panel">
    ...
    <details className="advanced-customizations" open={issues.length > 0 || undefined}>
      ...
      <div className="customization-list">{customizations.aliases.map((entry) => <div className="customization-item alias-editor" key={entry.id}>
      ...
      <div className="customization-list">{customizations.functions.map((entry) => <div className="customization-item code-editor" key={entry.id}>
      ...
      <div className="customization-list">{customizations.commands.map((entry) => <div className="customization-item code-editor" key={entry.id}>
