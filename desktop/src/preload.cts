...
const channels = {
  ...
  selectStartingDirectory: 'powershell-config:select-starting-directory',
...
const api: DesktopApi = {
  ...
  selectBackgroundImage: () => ipcRenderer.invoke(channels.selectBackgroundImage),
  selectProfileIcon: () => ipcRenderer.invoke(channels.selectProfileIcon),
  selectStartingDirectory: () => ipcRenderer.invoke(channels.selectStartingDirectory),
